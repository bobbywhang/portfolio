...
$('#map').after('<div id="showwork-background"></div><div id="showwork"><a id="showwork-close" href="#"><i class="fa fa-times-circle"></i></a><div id="showwork-loader"><img src="img/indicator.gif" alt="One moment please..." class="go-retina" width="24px" height="24px"></div><div id="showwork-content"></div></div>');
$('#showwork-background,#showwork,#showwork-close,#showwork-loader,#showwork-content').hide();



	if (Modernizr.mq('(min-device-width: 768px)')) $('#global-nav').addClass('navbar-fixed-top');
